	...
	<div class="ui container">
		...
		<div class="html ui top attached segment" id="outputPanel"
			...
			<div class="ui warning message">
				<div class="header">Please make correction on the parsing
					panel.</div>
				This is automated parsing results. Human inspections are required to
		...
		<div class="html ui top attached segment" id="genePanel"
			...
			<div class="ui warning message">
				<div class="header">
					The gene prioritization results are generated by <a
						href='http://phen2gene.wglab.org/' target="_blank">Phen2Gene</a>
				</div>
				predicted gene is based on searching along the gene-gene interaction
				network.
			</div>
					...
					<div class="extra content">
						<div class="ui list">
							...
							<div class="item" id="Phevor2Button">
								<button
									href="http://weatherby.genetics.utah.edu/phevor2/index.html"
