...
//		List<String> cmd = new ArrayList<String>(Arrays.asList(command.split(" ")));
		...
		File theDir = new File("/Users/congliu/eclipse-workspace/.metadata/.plugins/org.eclipse.wst.server.core/tmp1/wtpwebapps/note2gene/WEB-INF/work/asdfghjkl/");
		File phenolyzerDir = new File("/Users/congliu/eclipse-workspace/.metadata/.plugins/org.eclipse.wst.server.core/tmp1/wtpwebapps/note2gene/WEB-INF/scripts/");
