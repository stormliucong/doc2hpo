...
public class MetaMapLiteParser {
	...
	public MetaMapLiteParser(String metamapliteDataRoot) throws FileNotFoundException, IOException, ClassNotFoundException,
			InstantiationException, NoSuchMethodException, IllegalAccessException {
		// Initialization Section
		Properties myProperties = new Properties();
		
		String dataRoot = metamapliteDataRoot;
